        ...
        <div className="bg-lightprimary py-4 px-5 rounded-lg ">
          <div className="grid grid-cols-12">
            <div className="col-span-7">
              ...
              <Button color={"primary"} className="mt-3" size={'sm'} as={Link} href="https://www.wrappixel.com/templates/NVision(InOfficeMessaging)-next-js-tailwind-dashboard-template/?ref=33" target="_blank">
                Buy Pro
              </Button>
            </div>
